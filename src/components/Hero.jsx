...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Specialty Effects */}
      <div
        className="embers absolute inset-0 pointer-events-none z-[6]"
        ref={embersRef}
      />
      ...
      <div className="relative z-20 container mx-auto px-6 py-20 lg:py-0 w-full flex flex-col lg:flex-row items-center justify-between min-h-screen gap-12 mt-[7rem]">
        <div className="w-full text-center lg:text-left">
          ...
          <h1 className="flex flex-col font-oswald font-black uppercase leading-[0.85] mb-8">
            ...
            >
              LEGEND{" "}
              <span className="font-greatvibes text-brand-gold text-7xl md:text-8xl normal-case tracking-normal">
                Experience
              </span>
            </motion.span>
          </h1>
          ...
          >
            <p className="font-inter text-xl text-white/60 leading-relaxed max-w-md border-l-4 border-brand-red pl-6 italic mx-auto lg:mx-0">
              "We don't just grill meat. We master the fire to bring you the
              legendary smash and sizzle."
            </p>
